...
- Kotlin como a minha co-linguagem de desenvolvimento.
...
- Docker Compose para trabalhar com orquestração de containers.
- Visual Studio Code
- Angular e Vue como frameworks frontend.
- Vuetify, Pinia, Vue Router como parte do ecossistema Vue.
- JavaScript e TypeScript.
- Git para o versionamento dos meus projetos usando o fluxo de trabalho da convenção git-flow.
- Postman para gerar documentações e realizar testes em minhas API's.
- Builders.
...
<div align="center">
  <a href="https://skillicons.dev">
    <img src="https://skillicons.dev/icons?i=java,kotlin,idea,spring,mysql,postgres,aws,docker,vscode,angular,vue,vuetify,pinia,html,css,js,ts,git,postman,maven,vite" alt="My Skills"/>
  </a>
</div>
